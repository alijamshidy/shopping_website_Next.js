          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0 md:max-w-xl">
              ...
              <p className="text-white/80">
                Get the latestproducts, promotions, and tech news delivered to
                your inbox.
              </p>
            </div>
            <div className="w-full md:w-auto">
              <form className="flex flex-col md:flex-row gap-2 ">
                <input
                  ...
                  className="px-5 py-3 rounded-lg bg-white/10 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#edae49] min-w-60 transition-all"
                  required
                />
                <button
                  type="submit"
                  className="bg-[#edae49] hover:bg-[#edae49]/90 text-white px-6 py-3 rounded-lg hover:scale-105 transform font-medium flex items-center justify-center ">
        ...
        <div className="grid grid-cols md:grid-cols-12 gap-8">
          <div className="col-span-2 md:col-span-4">
            <Link
              ...
              <div className="bg-[#edae49] text-[#003d5b] w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg mr-2">
                SB
              </div>
            ...
            <div className="flex space-x-4">
              {["facebook", "twitter", "instagram", "youtube"].map(platform => (
                <a
                  key={platform}
                  href="#"
                  className="group flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 hover:bg-[#003d5b] scale-110">
                  <i
                    className={`bx bxl-${platform} text-gray-500 group-hover:text-white text-xl transition-colors`}></i>
                </a>
              ))}
            </div>
          </div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link
                  ...
                  View All{" "}
                  <i className="bx bx-right-arrow-alt ml-1 opacity-70 group-hover:transition-transform"></i>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <ul className="space-y-2.5">
              {["Contact Us", "FAQs", "Shipping", "Returns", "Trak Order"].map(
                item => (
                  <li key={item}>
                    <a
                      className="text-gray-600 hover:text-[#00798c] hover:translate-x-1 inline-block transition-all"
