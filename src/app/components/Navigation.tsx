          ...
          <div className="hidden md:block grow max-w-lg mx-8">
            <form className=" group relative w-full">
              <input
                ...
                className="w-full relative bg-white/10 border border-white/20 rounded-full py-2 pl-4 pr-10 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#edae49] focus:border-transparent transition-all"
              />
              <button
                type="submit"
                className="  absolute right-1 top-7/12 -translate-y-1/2 text-white/70 p-1.5 hover:text-white rounded-full transition-colors">
