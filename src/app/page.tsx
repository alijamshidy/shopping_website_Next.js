        ...
        <div className="max-w-7xl mx-auto px-4 pt-24 h-full flex flex-col">
          <div className="grow flex flex-col md:flex-row items-center justify-center md:justify-between">
            <div className="w-1/2 text-center md:text-left mb-10 md:mb-0 z-10">
              <h1 className="text-4xl sm:text-5xl md:text-5xl font-extrabold text-white tracking-tight">
                <div className="mb-2">
              ...
              <p className="text-xl text-white/80 max-w-lg mb-10">
                Experience exceptional quality and service with our created
                selection of premium products.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  href={`/products`}
                  className="bg-[#d1495b] hover:bg-[#d1495b]/90 text-white px-8 py-3 rounded-full transform hover:scale-105 shadow-lg font-medium flex items-center justify-center transition-all">
